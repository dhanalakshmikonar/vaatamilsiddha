...
<div class="form-container">
    ...
    <div class="form-header">
        <h2><i class="fa-solid fa-user-plus" style="color:var(--primary);margin-right:8px;"></i> Register New Patient</h2>
        <p>Record patient personal details, medical history, clinical diagnosis, and prescribe herbal medicines.</p>
    </div>
    ...
    <form method="POST" action="/patients" id="patientCreateForm">
        @csrf
            ...
            <div class="form-group full">
                ...
                <div class="history-panel" id="history-panel" style="display:none;">
                    ...
                    <div class="history-grid">
                        ...
                        @php
                            $val = strtoupper(old('patient_history.' . $key, '-'));
        ...
        <div class="form-actions" style="margin-top:32px;">
            <button type="submit" class="btn" style="padding:12px 24px;font-size:14px;">
                <i class="fa-solid fa-check"></i> Save Patient Record
            </button>
...
document.addEventListener('DOMContentLoaded', function() {
    if (oldMedicineIds && oldMedicineIds.length) {
